...
from edfi_amt_data_lake.parquet.Common.pandasWrapper import pdMerge,jsonNormalize, subset, renameColumns, saveParquetFile, to_datetime_key, get_descriptor_code_value_from_uri
...
def grading_period_dim(school_year) -> None:
    ...
    grading_period_descriptor_normalize =  jsonNormalize(
        ...
        ,recordPath=None
        ,meta=['gradingPeriodDescriptorId'
            ,'codeValue'
        ]
        ,metaPrefix=None,
        recordPrefix=None,
